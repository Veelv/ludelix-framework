 ...
 * Tenant Interface
 * 
 * Defines the comprehensive contract for multi-tenant architecture implementation
 * in enterprise-grade applications. This interface establishes the foundation
 * for sophisticated tenant isolation, management, and lifecycle operations.
 * 
 * The interface supports multiple tenancy models:
 * - Single Database Multi-Schema (SDMS)
 * - Multi-Database Single-Schema (MDSS) 
 * - Hybrid Multi-Database Multi-Schema (MDMS)
 ...
 * - Hierarchical tenant structures (parent-child relationships)
 * - Tenant-specific configuration inheritance
 * - Dynamic tenant provisioning and deprovisioning
 * - Tenant resource quotas and usage monitoring
 * - Cross-tenant data sharing with permission controls
 ...
 * @since 1.0.0
 * 
 * @see TenantManager For primary implementation
 * @see TenantResolver For tenant resolution strategies
 * @see TenantConfig For tenant-specific configuration
 */
