...
/**
 * GtRule - Validates that a field is greater than another field
 */
class GtRule extends RuleContract
{
    ...
    public function message(string $field, mixed $value, array $parameters = []): string
    {
        ...
        $otherField = $this->getFirstParameter();
        return $translation->t('validation.gt', ['field' => $field, 'other' => $otherField]);
    }
