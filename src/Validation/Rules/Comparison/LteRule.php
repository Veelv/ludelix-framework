...
/**
 * LteRule - Validates that a field is less than or equal to another field
 */
class LteRule extends RuleContract
{
    ...
    public function message(string $field, mixed $value, array $parameters = []): string
    {
        ...
        $otherField = $this->getFirstParameter();
        return $translation->t('validation.lte', ['field' => $field, 'other' => $otherField]);
    }
