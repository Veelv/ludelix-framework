...
class VueGenerator extends BaseGenerator
{
  ...
  protected function createConfigurationFiles(): void
  {
    ...
    // Create Vite config
    $this->createViteConfig('vue', $this->options);
  ...
  protected function createVueComponents(): void
  {
    ...
    $this->writeFile($this->projectRoot . '/frontend/js/components/App.vue', $appComponent);

    // Create Layout component
    $layoutComponent = $this->getLayoutComponent();
    $this->writeFile($this->projectRoot . '/frontend/js/components/Layout.vue', $layoutComponent);
  ...
  {
    $pages = [
      'Home.vue' => $this->getHomePage(),
      'About.vue' => $this->getAboutPage(),
      'Contact.vue' => $this->getContactPage()
    ];
...
export default {
  ...
  <Layout>
    <div class="container mx-auto px-4 py-8">
      ...
      <p class="text-gray-600">Your modern PHP + Vue application</p>
    </div>
  </Layout>
</template>
